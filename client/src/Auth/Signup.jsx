        ...
        <div className='flex justify-center items-center min-h-screen bg-gray-100'>
            <div className='bg-white shadow-lg rounded-lg p-6 max-w-md w-full text-center space-y-4 '>
                ...
                <form onSubmit={signup} className='space-y-4'>
                    ...
                    <button className='bg-linear-to-r from-indigo-400 via-blue-500 to-indigo-500 text-white hover:scale-105 transition-transform duration-300 w-full px-4 py-1.5 rounded-full'>
                        Signup
                    </button>
                </form>
